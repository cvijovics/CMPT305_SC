...
public class AssessmentClass {
    ...
    {
        assessmentClass1 = singleData[10].toLowerCase();
        assessmentClass1Percent = Integer.parseInt(singleData[13]);


        if(singleData[11] == null || singleData[11].trim().isEmpty()) {
            assessmentClass2 = null;
            assessmentClass2Percent = null;
        } else {
            assessmentClass2 = singleData[11].toLowerCase();
        ...
        if(singleData[12] == null || singleData[12].trim().isEmpty() || singleData[15] == null || singleData[15].trim().isEmpty()) {
            ...
            assessmentClass3 = singleData[12].toLowerCase();
    ...
    @Override
    public int hashCode(){
        return Objects.hash(assessmentClass1, assessmentClass2,
                assessmentClass3, assessmentClass1Percent,
                assessmentClass2Percent, assessmentClass3Percent);
    }
    ...
    public boolean equals(Object other){
        ...
        return Objects.equals(otherAssessment.getAssessmentClass3(), this.getAssessmentClass3())
                && Objects.equals(otherAssessment.getAssessmentClass3Percent(), this.getAssessmentClass3Percent())
                && Objects.equals(otherAssessment.getAssessmentClass2(), this.getAssessmentClass2())
                && Objects.equals(otherAssessment.getAssessmentClass2Percent(), this.getAssessmentClass2Percent())
                && Objects.equals(otherAssessment.getAssessmentClass1(), this.getAssessmentClass1())
                && Objects.equals(otherAssessment.getAssessmentClass1Percent(), this.getAssessmentClass1Percent());
